<%-- 
    Document   : dashboard
    Created on : Sep 8, 2014, 10:31:21 AM
    Author     : Maureen
--%>
...
<head>
    <meta charset="UTF-8" />
    <title>TrueVine Medical Centre | Dashboard </title>
	...
	<meta content="" name="author" />
     <!--[if IE]>
        ...
        <![endif]-->
    <!-- GLOBAL STYLES -->
    <link rel="stylesheet" href="bcore/assets/plugins/bootstrap/css/bootstrap.css" />
    <link rel="stylesheet" href="bcore/assets/css/main.css" />
    <link rel="stylesheet" href="bcore/assets/css/theme.css" />
    <link rel="stylesheet" href="bcore/assets/css/MoneAdmin.css" />
    <link rel="stylesheet" href="bcore/assets/plugins/Font-Awesome/css/font-awesome.css" />
    <!--END GLOBAL STYLES -->

    <!-- PAGE LEVEL STYLES -->
    <link href="bcore/assets/css/layout2.css" rel="stylesheet" />
       <link href="bcore/assets/plugins/flot/examples/examples.css" rel="stylesheet" />
       <link rel="stylesheet" href="bcore/assets/plugins/timeline/timeline.css" />
...
<body class="padTop53 " >
        ...
        <div id="top">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top " style="padding-top: 10px;">
                ...
                <header class="navbar-header">
                    ...
                    <img src="bcore/assets/img/logo.png" alt="" />
       ...
       <div id="left" >
            <div class="media user-media well-small">
                <a class="user-link" href="#">
                    <img class="media-object img-thumbnail user-img" alt="User Picture" src="bcore/assets/img/user.gif" />
                </a>
                <br />
                                ...
                                <ul class="chat">
                                    <li class="left clearfix">
                                        <span class="chat-img pull-left">
                                            <img src="bcore/assets/img/1.png" alt="User Avatar" class="img-circle" />
                                        </span>
                                    ...
                                    <li class="right clearfix">
                                        <span class="chat-img pull-right">
                                            <img src="bcore/assets/img/2.png" alt="User Avatar" class="img-circle" />
                                        </span>
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                    ...
                                    <li class="left clearfix">
                                        <span class="chat-img pull-left">
                                            <img src="bcore/assets/img/3.png" alt="User Avatar" class="img-circle" />
                                        </span>
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                                <strong class="primary-font"> Jack Sparrow </strong>
                                    ...
                                    <li class="right clearfix">
                                        <span class="chat-img pull-right">
                                            <img src="bcore/assets/img/4.png" alt="User Avatar" class="img-circle" />
                                        </span>
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                                <small class=" text-muted">
    ...
    <!-- GLOBAL SCRIPTS -->
    <script src="bcore/assets/plugins/jquery-2.0.3.min.js"></script>
     <script src="bcore/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
    <script src="bcore/assets/plugins/modernizr-2.6.2-respond-1.1.0.min.js"></script>
    <!-- END GLOBAL SCRIPTS -->

    <!-- PAGE LEVEL SCRIPTS -->
    <script src="bcore/assets/plugins/flot/jquery.flot.js"></script>
    <script src="bcore/assets/plugins/flot/jquery.flot.resize.js"></script>
    <script src="bcore/assets/plugins/flot/jquery.flot.time.js"></script>
     <script  src="bcore/assets/plugins/flot/jquery.flot.stack.js"></script>
    <script src="bcore/assets/js/for_index.js"></script>
